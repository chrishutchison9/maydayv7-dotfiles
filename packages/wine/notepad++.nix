...
in
  mkWindowsAppNoCC rec {
    ...
    desktopItems = let
      textTypes = map (s: "text/" + s) ["plain" "html" "rust" "vbscript" "x-cmake" "x-changelog" "x-cobol" "x-common-lisp" "x-csharp" "x-c++src" "x-csrc" "x-erlang" "x-fortran" "x-haskell" "x-java" "x-log" "x-makefile" "x-objcsrc" "x-python" "x-readme" "x-scheme" "x-install"];
      appTypes = map (s: "application/" + s) ["json" "x-msi" "xml" "x-perl"];
